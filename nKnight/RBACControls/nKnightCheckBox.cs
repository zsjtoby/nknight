...
{
    public delegate void OnRBACCheckBoxError(CheckBoxControlEventArgs e);
    [DefaultProperty("GroupUniqueID")]
    public partial class nKnightCheckBox : CheckBox
    {
        public nKnightCheckBox()
        {
            InitializeComponent();
        }
        [Category("Action")]
        [Description("Fires when Error occures")]
        public event OnRBACCheckBoxError oError;
        void OnErrorRaised(CheckBoxControlEventArgs e)
        {
            if (oError != null)
            {
                oError(e);
        ...
        protected override void OnClick(EventArgs e)
        {
            ...
            {
                this.Checked = false;
                CheckBoxControlEventArgs cnt = new CheckBoxControlEventArgs();
    ...
    public class CheckBoxControlEventArgs : EventArgs
    {
