...
{
    public delegate void OnRBACRadioButtonError(RadioButtonControlEventArgs e);
    [DefaultProperty("GroupUniqueID")]
    public partial class nKnightRadioButton : RadioButton
    {

        public nKnightRadioButton()
        {
            //this.TabStop = false;
            InitializeComponent();
        }
        ...
        public event OnRBACRadioButtonError oError;
        void OnErrorRaised(RadioButtonControlEventArgs e)
        {
            if (oError != null)
            {
                oError(e);
        ...
        protected override void OnClick(EventArgs e)
        {
            ...
            {
                this.Checked = false;
                RadioButtonControlEventArgs cnt = new RadioButtonControlEventArgs();
    ...
    public class RadioButtonControlEventArgs : EventArgs
    {
