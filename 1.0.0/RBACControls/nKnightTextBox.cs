...
{
    public delegate void OnTextBoxError(TextBoxControlEventArgs e);
    [DefaultProperty("GroupUniqueID")]
    public partial class nKnightTextBox : TextBox
    {
        [Category("Action")]
        [Description("Fires when Error occures")]
        public event OnTextBoxError oError;
    ...
    public class TextBoxControlEventArgs : EventArgs
    {
