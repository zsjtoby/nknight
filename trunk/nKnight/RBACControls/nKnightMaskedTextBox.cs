...
{
    public delegate void OnRBACMaskedTextBoxError(MaskedTextBoxControlEventArgs e);
    [DefaultProperty("GroupUniqueID")]
    public partial class nKnightMaskedTextBox : MaskedTextBox
    {
        public nKnightMaskedTextBox()
        {
            InitializeComponent();
        }
        [Category("Action")]
        [Description("Fires when Error occures")]
        public event OnRBACMaskedTextBoxError oError;
        void OnErrorRaised(MaskedTextBoxControlEventArgs e)
        {
            if (oError != null)
            {
                oError(e);
        ...
        protected override void OnKeyPress(KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true;
                MaskedTextBoxControlEventArgs cnt = new MaskedTextBoxControlEventArgs();
    ...
    public class MaskedTextBoxControlEventArgs : EventArgs
    {
