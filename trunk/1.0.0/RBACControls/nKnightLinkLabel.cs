...
{
    public delegate void OnRBACLinkLabelError(LinkLabelControlEventArgs e);
    [DefaultProperty("GroupUniqueID")]
    public partial class nKnightLinkLabel : LinkLabel
    {
        public nKnightLinkLabel()
        {
            InitializeComponent();
        }
        [Category("Action")]
        [Description("Fires when Error occures")]
        public event OnRBACLinkLabelError oError;
        void OnErrorRaised(LinkLabelControlEventArgs e)
        {
            if (oError != null)
            {
                oError(e);
        ...
        protected override void  OnLinkClicked(LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (message == string.Empty) { base.OnLinkClicked(e); }
            else
            {
                LinkLabelControlEventArgs cnt = new LinkLabelControlEventArgs();
    ...
    public class LinkLabelControlEventArgs : EventArgs
    {
